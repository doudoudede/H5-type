    ...
    <xe-layout class="m-flexlay">
        ...
        <div class="m-search-barcon" slot="header">
            ...
            <div class="m-search-bar m-searchresult-top">
                ...
                <v-touch tag="div" v-show='parseInt($route.query.type) === 1' class="filter" @tap="filterFn">
                    <span class="xe-iconfont xe-icon-filter"></span>
                </v-touch>
            </div>
        </div>
        <div class="m-category-tab" slot="header" v-if="parseInt($route.query.type) === 1">
            <div>
...
<style rel="stylesheet/scss" lang="scss">
   ...
   .m-dropdown>div:nth-child(1){position: absolute;left:8%;width:30% } 
    // .m-dropdown>div:nth-child(2){position: absolute;left:8%;width:30% } 
      .m-dropdown>div:nth-child(3) ,.m-dropdown>div:nth-child(4){ font-size: .22rem;  position: absolute; right:8%;}
   .m-dropdown>div:nth-child(4){position: absolute;top:-15% }
     .m-dropdown>div:nth-child(3){position: absolute;top:15% }
         .m-dropdown>div:nth-child(5){position: absolute;right:13%; }
</style>

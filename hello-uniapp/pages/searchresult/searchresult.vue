    ...
    <xe-layout class="m-flexlay">
        ...
        <view class="m-search-barcon" slot="header">
            ...
            <view class="m-search-bar m-searchresult-top">
                ...
                <v-touch tag="view" v-show='parseInt($route.query.type) === 1' class="filter" @tap="filterFn">
                    <span class="xe-iconfont xe-icon-filter"></span>
                </v-touch>
            </view>
        </view>
        <view class="m-category-tab" slot="header" v-if="parseInt($route.query.type) === 1">
            <view>
    ...
    export default {
        ...
        data() {
            return {
                ...
                searchUrl: '/xe-route/xe-app/mobileApp/product/searchProduct',
                consText: '综合',
                picServerPro: '',
                picServerVendor: '',
                consData: [
        ...
        created() {
            ...
            if (parseInt(this.$route.query.type) === 1) {
                this.searchUrl = '/xe-route/xe-app/mobileApp/product/searchProduct';
            } else {
                this.searchUrl = '/xe-route/xe-app/mobileApp/vendor/searchVendor';
            }
        },
        activated() {
            if (!this.firstIn) {
...
<style rel="stylesheet/scss" lang="scss">
    ...
    .m-dropdown{ display: flex;justify-content: space-around;width: 100%;
    margin-left: 0;
    position: absolute;
    top: 0.2rem;
    left: 0;
    z-index: 333;}
    .m-dropdown:before{display: none}
   .m-dropdown>view:nth-child(1){position: absolute;left:8%;width:30% } 
    // .m-dropdown>view:nth-child(2){position: absolute;left:8%;width:30% } 
      .m-dropdown>view:nth-child(3) ,.m-dropdown>view:nth-child(4){ font-size: .22rem;  position: absolute; right:8%;}
   .m-dropdown>view:nth-child(4){position: absolute;top:-15% }
     .m-dropdown>view:nth-child(3){position: absolute;top:15% }
         .m-dropdown>view:nth-child(5){position: absolute;right:13%; }
</style>

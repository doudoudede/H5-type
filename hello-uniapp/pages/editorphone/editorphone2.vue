<template>
    <xe-layout class="m-bg-dark m-flexlay">
                ...
                <ul>
                    <li class="item-content">
                        <view class="item-inner">
                            <view class="item-title">新手机号</view>
                            <view class="item-input">
                                <input type="tel" v-model="onephone" maxlength="11" placeholder="输入新手机号">
                            </view>
                            <view class="act">
        ...
        <view class="m-cphone-tips">
            <em class="xe-iconfont xe-icon-tishi"></em>修改后的绑定手机号，将作为您新的登录号
        </view>
        <view class="m-cphone-btn">
            <mt-button type="primary" :disabled="disabledBtn" class="xe-button-primary" style="width: 100%;" @click.prevent="btnfn">确定</mt-button>
        </view>
...
//                };
            ...
            updatebindMobile() {
                this.$http({
                    method: 'post',
                    url: '/xe-route/xe-app/mobile/myIndex/updatebindMobile',
                    data: {
